...
{
	if (region.b8.aX === region.ct.aX)
	{
		return 'on line ' + region.b8.aX;
	}
	return 'on lines ' + region.b8.aX + ' through ' + region.ct.aX;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ep: 'hidden', d1: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ep: 'mozHidden', d1: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ep: 'msHidden', d1: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ep: 'webkitHidden', d1: 'webkitvisibilitychange' }
		: { ep: 'hidden', d1: 'visibilitychange' };
}
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bS: oldTime, dg: request, dl: subs};
	});
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cx: fragment, cC: host, c8: path, da: port_, dd: protocol, de: query};
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'target',
				A2($elm$json$Json$Decode$field, info.ep, $elm$json$Json$Decode$bool))));
};
...
var $evancz$elm_playground$Playground$toScreen = F2(
	function (width, height) {
		return {bx: (-height) / 2, cz: height, Z: (-width) / 2, aE: width / 2, ca: height / 2, dv: width};
	});
var $evancz$elm_playground$Playground$animationUpdate = F2(
	function (msg, state) {
		...
		switch (msg.$) {
			case 1:
				var posix = msg.a;
				return A3($evancz$elm_playground$Playground$Animation, v, s, posix);
			case 4:
				var vis = msg.a;
				return A3($evancz$elm_playground$Playground$Animation, vis, s, t);
			case 2:
				var viewport = msg.a.dt;
				return A3(
					$evancz$elm_playground$Playground$Animation,
					v,
					A2($evancz$elm_playground$Playground$toScreen, viewport.dv, viewport.cz),
					t);
			case 3:
				var w = msg.a;
				var h = msg.b;
...
var $evancz$elm_playground$Playground$render = F2(
	function (screen, shapes) {
		var y = $elm$core$String$fromFloat(screen.bx);
		var x = $elm$core$String$fromFloat(screen.Z);
		var w = $elm$core$String$fromFloat(screen.dv);
		var h = $elm$core$String$fromFloat(screen.cz);
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $evancz$elm_playground$Playground$animation = function (viewFrame) {
	...
	return $elm$browser$Browser$document(
		{cE: init, fe: subscriptions, dp: update, ds: view});
};
...
var $ianmackenzie$elm_geometry$Vector3d$cross = F2(
	function (_v0, _v1) {
		var v2 = _v0;
		var v1 = _v1;
		return {dy: (v1.dz * v2.bq) - (v1.bq * v2.dz), dz: (v1.bq * v2.dy) - (v1.dy * v2.bq), bq: (v1.dy * v2.dz) - (v1.dz * v2.dy)};
	});
...
var $ianmackenzie$elm_geometry$Vector3d$direction = function (_v0) {
	...
	var largestComponent = A2(
		$elm$core$Basics$max,
		$elm$core$Basics$abs(v.dy),
		A2(
			$elm$core$Basics$max,
			$elm$core$Basics$abs(v.dz),
			$elm$core$Basics$abs(v.bq)));
	if (!largestComponent) {
		return $elm$core$Maybe$Nothing;
	} else {
		var scaledZ = v.bq / largestComponent;
		var scaledY = v.dz / largestComponent;
		var scaledX = v.dy / largestComponent;
		var scaledLength = $elm$core$Basics$sqrt(((scaledX * scaledX) + (scaledY * scaledY)) + (scaledZ * scaledZ));
		return $elm$core$Maybe$Just(
			{dy: scaledX / scaledLength, dz: scaledY / scaledLength, bq: scaledZ / scaledLength});
	}
};
var $ianmackenzie$elm_geometry$Vector3d$from = F2(
	function (_v0, _v1) {
		var p1 = _v0;
		var p2 = _v1;
		return {dy: p2.dy - p1.dy, dz: p2.dz - p1.dz, bq: p2.bq - p1.bq};
	});
...
var $ianmackenzie$elm_geometry$Vector3d$dot = F2(
	function (_v0, _v1) {
		var v2 = _v0;
		var v1 = _v1;
		return ((v1.dy * v2.dy) + (v1.dz * v2.dz)) + (v1.bq * v2.bq);
	});
...
var $ianmackenzie$elm_geometry$Vector3d$minus = F2(
	function (_v0, _v1) {
		var v2 = _v0;
		var v1 = _v1;
		return {dy: v1.dy - v2.dy, dz: v1.dz - v2.dz, bq: v1.bq - v2.bq};
	});
var $ianmackenzie$elm_geometry$Vector3d$projectionIn = F2(
	function (_v0, _v1) {
		var d = _v0;
		var v = _v1;
		var projectedLength = ((v.dy * d.dy) + (v.dz * d.dz)) + (v.bq * d.bq);
		return {dy: d.dy * projectedLength, dz: d.dz * projectedLength, bq: d.bq * projectedLength};
	});
var $ianmackenzie$elm_geometry$Vector3d$reverse = function (_v0) {
	var v = _v0;
	return {dy: -v.dy, dz: -v.dz, bq: -v.bq};
};
var $ianmackenzie$elm_units$Quantity$zero = 0;
var $ianmackenzie$elm_geometry$Vector3d$zero = {dy: 0, dz: 0, bq: 0};
...
var $ianmackenzie$elm_geometry$Direction3d$perpendicularTo = function (_v0) {
	var d = _v0;
	var absZ = $elm$core$Basics$abs(d.bq);
	var absY = $elm$core$Basics$abs(d.dz);
	var absX = $elm$core$Basics$abs(d.dy);
	if (_Utils_cmp(absX, absY) < 1) {
		if (_Utils_cmp(absX, absZ) < 1) {
			var scale = $elm$core$Basics$sqrt((d.bq * d.bq) + (d.dz * d.dz));
			return {dy: 0, dz: (-d.bq) / scale, bq: d.dz / scale};
		} else {
			var scale = $elm$core$Basics$sqrt((d.dz * d.dz) + (d.dy * d.dy));
			return {dy: (-d.dz) / scale, dz: d.dy / scale, bq: 0};
		}
	} else {
		if (_Utils_cmp(absY, absZ) < 1) {
			var scale = $elm$core$Basics$sqrt((d.bq * d.bq) + (d.dy * d.dy));
			return {dy: d.bq / scale, dz: 0, bq: (-d.dy) / scale};
		} else {
			var scale = $elm$core$Basics$sqrt((d.dy * d.dy) + (d.dz * d.dz));
			return {dy: (-d.dz) / scale, dz: d.dy / scale, bq: 0};
		}
	}
};
var $ianmackenzie$elm_geometry$Direction3d$perpendicularBasis = function (direction) {
	...
	var _v1 = direction;
	var d = _v1;
	var yDirection = {dy: (d.dz * dX.bq) - (d.bq * dX.dz), dz: (d.bq * dX.dy) - (d.dy * dX.bq), bq: (d.dy * dX.dz) - (d.dz * dX.dy)};
...
var $ianmackenzie$elm_geometry$Frame3d$withZDirection = F2(
	function (givenZDirection, givenOrigin) {
		...
		return $ianmackenzie$elm_geometry$Frame3d$unsafe(
			{bT: givenOrigin, cg: computedXDirection, ch: computedYDirection, ci: givenZDirection});
	});
var $ianmackenzie$elm_3d_camera$Viewpoint3d$lookAt = function (_arguments) {
	var zVector = A2($ianmackenzie$elm_geometry$Vector3d$from, _arguments.el, _arguments.ej);
	var yVector = $ianmackenzie$elm_geometry$Direction3d$toVector(_arguments.fx);
	...
	if (!_v0.$) {
		...
		return $ianmackenzie$elm_geometry$Frame3d$unsafe(
			{bT: _arguments.ej, cg: normalizedXDirection, ch: normalizedYDirection, ci: normalizedZDirection});
	} else {
		var _v2 = $ianmackenzie$elm_geometry$Vector3d$direction(zVector);
		if (!_v2.$) {
			var zDirection = _v2.a;
			return A2($ianmackenzie$elm_geometry$Frame3d$withZDirection, zDirection, _arguments.ej);
		} else {
			var _v3 = $ianmackenzie$elm_geometry$Direction3d$perpendicularBasis(_arguments.fx);
			var arbitraryZDirection = _v3.a;
			var arbitraryXDirection = _v3.b;
			return $ianmackenzie$elm_geometry$Frame3d$unsafe(
				{bT: _arguments.ej, cg: arbitraryXDirection, ch: _arguments.fx, ci: arbitraryZDirection});
		}
	}
};
...
var $ianmackenzie$elm_geometry$Point3d$along = F2(
	function (_v0, _v1) {
		...
		var _v3 = axis.E;
		var d = _v3;
		return {dy: p0.dy + (distance * d.dy), dz: p0.dz + (distance * d.dz), bq: p0.bq + (distance * d.bq)};
	});
...
var $ianmackenzie$elm_geometry$Direction3d$reverse = function (_v0) {
	var d = _v0;
	return {dy: -d.dy, dz: -d.dz, bq: -d.bq};
};
...
var $ianmackenzie$elm_geometry$Plane3d$through = F2(
	function (givenPoint, givenNormalDirection) {
		return {eM: givenNormalDirection, bT: givenPoint};
	});
...
var $ianmackenzie$elm_geometry$Axis3d$through = F2(
	function (givenPoint, givenDirection) {
		return {E: givenDirection, bT: givenPoint};
	});
var $ianmackenzie$elm_geometry$Frame3d$zAxis = function (_v0) {
	var frame = _v0;
	return A2($ianmackenzie$elm_geometry$Axis3d$through, frame.bT, frame.ci);
};
var $ianmackenzie$elm_geometry$Frame3d$zDirection = function (_v0) {
	var properties = _v0;
	return properties.ci;
};
...
var $ianmackenzie$elm_3d_camera$Camera3d$perspective = function (_arguments) {
	var halfFieldOfView = $ianmackenzie$elm_units$Quantity$half(
		$ianmackenzie$elm_units$Quantity$abs(_arguments.fy));
	var frustumSlope = $ianmackenzie$elm_units$Angle$tan(halfFieldOfView);
	var absoluteClipDepth = $ianmackenzie$elm_units$Quantity$abs(_arguments.d3);
	return {
		d3: absoluteClipDepth,
		bz: A2($ianmackenzie$elm_3d_camera$Camera3d$offsetClipPlane, _arguments.fz, absoluteClipDepth),
		bi: $ianmackenzie$elm_3d_camera$Camera3d$Types$Perspective(frustumSlope),
		fz: _arguments.fz
	};
};
...
var $ianmackenzie$elm_geometry$Point3d$signedDistanceFrom = F2(
	function (_v0, _v1) {
		...
		var _v3 = plane.eM;
		var n = _v3;
		return (((p.dy - p0.dy) * n.dy) + ((p.dz - p0.dz) * n.dz)) + ((p.bq - p0.bq) * n.bq);
	});
...
var $ianmackenzie$elm_geometry$Rectangle2d$axes = function (_v0) {
	var rectangle = _v0;
	return $ianmackenzie$elm_geometry$Frame2d$copy(rectangle.dO);
};
...
var $ianmackenzie$elm_geometry$Point3d$xCoordinateIn = F2(
	function (_v0, _v1) {
		...
		var _v3 = frame.cg;
		var d = _v3;
		return (((p.dy - p0.dy) * d.dy) + ((p.dz - p0.dz) * d.dz)) + ((p.bq - p0.bq) * d.bq);
	});
...
var $ianmackenzie$elm_geometry$Point2d$xyIn = F3(
	function (_v0, _v1, _v2) {
		...
		var _v5 = frame.cg;
		var i = _v5;
		return {dy: (p0.dy + (x * i.dy)) + (y * j.dy), dz: (p0.dz + (x * i.dz)) + (y * j.dz)};
	});
...
var $ianmackenzie$elm_geometry$Direction2d$negativeX = {dy: -1, dz: 0};
var $ianmackenzie$elm_geometry$Direction2d$negativeY = {dy: 0, dz: -1};
var $ianmackenzie$elm_geometry$Direction2d$positiveX = {dy: 1, dz: 0};
var $ianmackenzie$elm_geometry$Direction2d$positiveY = {dy: 0, dz: 1};
...
var $ianmackenzie$elm_geometry$Rectangle2d$axisAligned = F4(
	function (x1, y1, x2, y2) {
		...
		var computedAxes = $ianmackenzie$elm_geometry$Frame2d$unsafe(
			{bT: computedCenterPoint, cg: computedXDirection, ch: computedYDirection});
		return {dO: computedAxes, D: computedDimensions};
	});
...
var $author$project$Playground3d$camera = F3(
	function (_v0, _v1, point3d) {
		var x = _v0.a;
		var y = _v0.b;
		var z = _v0.c;
		var fx = _v1.a;
		...
		var rectOfView = $ianmackenzie$elm_geometry$Rectangle2d$with(
			{
				fC: $ianmackenzie$elm_units$Length$meters(0),
				fD: $ianmackenzie$elm_units$Length$meters(1),
				fF: $ianmackenzie$elm_units$Length$meters(600),
				fG: $ianmackenzie$elm_units$Length$meters(0)
			});
		var cameraViewpoint = $ianmackenzie$elm_3d_camera$Viewpoint3d$lookAt(
			{
				ej: A3($ianmackenzie$elm_geometry$Point3d$meters, x, y, z),
				el: A3($ianmackenzie$elm_geometry$Point3d$meters, fx, fy, fz),
				fx: $ianmackenzie$elm_geometry$Direction3d$positiveZ
			});
		var perspectiveCamera = $ianmackenzie$elm_3d_camera$Camera3d$perspective(
			{
				d3: $ianmackenzie$elm_units$Length$meters(1),
				fy: $ianmackenzie$elm_units$Angle$degrees(25),
				fz: cameraViewpoint
			});
		return A3($ianmackenzie$elm_3d_camera$Point3d$Projection$toScreenSpace, perspectiveCamera, rectOfView, point3d);
	});
var $author$project$Playground3d$camera1 = A2(
	$author$project$Playground3d$camera,
	_Utils_Tuple3(3000, 2500, 1450),
	_Utils_Tuple3(0, 0, -1100));
var $author$project$Playground3d$Group3d = function (a) {
	return {$: 2, a: a};
};
var $author$project$Playground3d$Shape3d = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Playground3d$group3d = function (shapes) {
	return A2(
		$author$project$Playground3d$Shape3d,
		1,
		$author$project$Playground3d$Group3d(shapes));
};
var $author$project$Playground3d$Polygon3d = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Playground3d$Words3d = F4(
	function (a, b, c, d) {
...
var $ianmackenzie$elm_geometry$Point3d$translateBy = F2(
	function (_v0, _v1) {
		var v = _v0;
		var p = _v1;
		return {dy: p.dy + v.dy, dz: p.dz + v.dz, bq: p.bq + v.bq};
	});
var $author$project$Playground3d$geometryMove = F2(
	function (_v0, point3d) {
		var dx = _v0.a;
		var dy = _v0.b;
		var dz = _v0.c;
		return A2(
			$ianmackenzie$elm_geometry$Point3d$translateBy,
			A3($ianmackenzie$elm_geometry$Vector3d$meters, dx, dy, dz),
			point3d);
	});
...
var $author$project$Playground3d$tripletTransformation = F5(
	function (geometryTransform, dx, dy, dz, _v0) {
		var px = _v0.a;
		var py = _v0.b;
		var pz = _v0.c;
		return A2(
			...
			A2(
				geometryTransform,
				_Utils_Tuple3(dx, dy, dz),
				A3($ianmackenzie$elm_geometry$Point3d$meters, px, py, pz)));
	});
var $author$project$Playground3d$move3d = F4(
	function (dx, dy, dz, _v0) {
		var o = _v0.a;
		var f = _v0.b;
		return A2(
			$author$project$Playground3d$Shape3d,
			...
			function () {
				switch (f.$) {
					case 0:
						...
						var positions = f.b;
						return A2(
							$author$project$Playground3d$Polygon3d,
							color,
							A2(
								$elm$core$List$map,
								A4($author$project$Playground3d$tripletTransformation, $author$project$Playground3d$geometryMove, dx, dy, dz),
								positions));
					case 1:
						var color = f.a;
						var position = f.b;
						...
						var string = f.d;
						return A4(
							$author$project$Playground3d$Words3d,
							color,
							A5($author$project$Playground3d$tripletTransformation, $author$project$Playground3d$geometryMove, dx, dy, dz, position),
							scale,
							string);
					default:
						var shapes = f.a;
						return $author$project$Playground3d$Group3d(
							A2(
								$elm$core$List$map,
								A3($author$project$Playground3d$move3d, dx, dy, dz),
								shapes));
				}
			}());
	});
var $author$project$Playground3d$polygon3d = F2(
	function (color, points) {
		return A2(
			$author$project$Playground3d$Shape3d,
			1,
			A2($author$project$Playground3d$Polygon3d, color, points));
	});
var $ianmackenzie$elm_geometry$Point3d$scaleAbout = F3(
	function (_v0, k, _v1) {
		var p0 = _v0;
		var p = _v1;
		return {dy: p0.dy + (k * (p.dy - p0.dy)), dz: p0.dz + (k * (p.dz - p0.dz)), bq: p0.bq + (k * (p.bq - p0.bq))};
	});
var $author$project$Playground3d$geometryScale = F2(
	function (_v0, point3d) {
		var dx = _v0.a;
		return A3(
...
var $author$project$Playground3d$scale3d = F2(
	function (dx, _v0) {
		var o = _v0.a;
		var f = _v0.b;
		return A2(
				...
				switch (f.$) {
					case 0:
						...
						return A2(
							...
							A2(
								$elm$core$List$map,
								A4($author$project$Playground3d$tripletTransformation, $author$project$Playground3d$geometryScale, dx, dx, dx),
								position));
					case 1:
						var color = f.a;
						var position = f.b;
						var scale = f.c;
						var string = f.d;
						return A4($author$project$Playground3d$Words3d, color, position, scale * dx, string);
					default:
						var shapes = f.a;
						return $author$project$Playground3d$Group3d(
							A2(
								$elm$core$List$map,
								function (shape) {
									return A2($author$project$Playground3d$scale3d, dx, shape);
								},
								shapes));
				}
			}());
	});
var $author$project$Playground3d$cube = F4(
	function (color1, color2, color3, size) {
		return A2(
			$author$project$Playground3d$scale3d,
			size,
			A4(
				...
				-0.5,
				-0.5,
				$author$project$Playground3d$group3d(
					_List_fromArray(
						[
							A2(
							$author$project$Playground3d$polygon3d,
...
var $evancz$elm_playground$Playground$darkRed = $evancz$elm_playground$Playground$Hex('#a40000');
var $evancz$elm_playground$Playground$darkYellow = $evancz$elm_playground$Playground$Hex('#c4a000');
var $author$project$Playground3d$fade3d = F2(
	function (o, _v0) {
		var f = _v0.b;
		switch (f.$) {
			case 0:
				return A2($author$project$Playground3d$Shape3d, o, f);
			case 1:
				return A2($author$project$Playground3d$Shape3d, o, f);
			default:
				var shapes = f.a;
				return A2(
					...
					$author$project$Playground3d$Group3d(
						A2(
							$elm$core$List$map,
							$author$project$Playground3d$fade3d(o),
							shapes)));
		}
	});
var $evancz$elm_playground$Playground$lightRed = $evancz$elm_playground$Playground$Hex('#ef2929');
var $evancz$elm_playground$Playground$lightYellow = $evancz$elm_playground$Playground$Hex('#fce94f');
...
var $ianmackenzie$elm_geometry$Point3d$rotateAround = F3(
	function (_v0, _v1, _v2) {
		...
		var _v3 = axis.bT;
		var p0 = _v3;
		var deltaX = p.dy - p0.dy;
		var deltaY = p.dz - p0.dz;
		var deltaZ = p.bq - p0.bq;
		var _v4 = axis.E;
		var d = _v4;
		var qx = d.dy * sinHalfAngle;
		var wx = qw * qx;
		var xx = qx * qx;
		var qy = d.dz * sinHalfAngle;
		var wy = qw * qy;
		var xy = qx * qy;
		var yy = qy * qy;
		var a22 = 1 - (2 * (xx + yy));
		var qz = d.bq * sinHalfAngle;
		var wz = qw * qz;
		var a01 = 2 * (xy - wz);
		var a10 = 2 * (xy + wz);
		var xz = qx * qz;
		...
		var a00 = 1 - (2 * (yy + zz));
		var a11 = 1 - (2 * (xx + zz));
		return {dy: ((p0.dy + (a00 * deltaX)) + (a01 * deltaY)) + (a02 * deltaZ), dz: ((p0.dz + (a10 * deltaX)) + (a11 * deltaY)) + (a12 * deltaZ), bq: ((p0.bq + (a20 * deltaX)) + (a21 * deltaY)) + (a22 * deltaZ)};
	});
var $ianmackenzie$elm_geometry$Point3d$origin = {dy: 0, dz: 0, bq: 0};
...
var $author$project$Playground3d$geometryRotate = F2(
	function (_v0, point3d) {
		var dx = _v0.a;
		var dy = _v0.b;
		var dz = _v0.c;
		return A3(
			...
			$ianmackenzie$elm_units$Angle$degrees(dz),
			A3(
				$ianmackenzie$elm_geometry$Point3d$rotateAround,
...
var $author$project$Playground3d$rotate3d = F4(
	function (dx, dy, dz, _v0) {
		var o = _v0.a;
		var f = _v0.b;
		return A2(
				...
				switch (f.$) {
					case 0:
						...
						return A2(
							...
							A2(
								$elm$core$List$map,
								A4($author$project$Playground3d$tripletTransformation, $author$project$Playground3d$geometryRotate, dx, dy, dz),
								positions));
					case 1:
						var color = f.a;
						var position = f.b;
						...
						return A4(
							$author$project$Playground3d$Words3d,
							color,
							A5($author$project$Playground3d$tripletTransformation, $author$project$Playground3d$geometryRotate, dx, dy, dz, position),
							scale,
							string);
					default:
						var shapes = f.a;
						return $author$project$Playground3d$Group3d(
							A2(
								$elm$core$List$map,
								function (shape) {
									return A4($author$project$Playground3d$rotate3d, dx, dy, dz, shape);
								},
								shapes));
				}
			}());
...
var $author$project$Playground3d$point3dto2d = F2(
	function (camera_, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var z = _v0.c;
		return A2(
			$elm$core$Maybe$map,
			$ianmackenzie$elm_geometry$Point2d$toTuple($ianmackenzie$elm_units$Length$inMeters),
			camera_(
...
var $author$project$Playground3d$removeMaybeType = F2(
	function (item, list) {
		if (item.$ === 1) {
			return list;
		} else {
...
var $author$project$Playground3d$shape3dto2d = F2(
	function (camera_, _v0) {
		var o = _v0.a;
		var f = _v0.b;
		switch (f.$) {
			case 0:
				...
				return A2(
					...
					A2(
						...
						A3(
							$elm$core$List$foldr,
							$author$project$Playground3d$removeMaybeType,
							_List_Nil,
							A2(
								$elm$core$List$map,
								$author$project$Playground3d$point3dto2d(camera_),
								listPoints))));
			case 1:
				var color = f.a;
				var position = f.b;
				...
				var string = f.d;
				var _v2 = function () {
					var _v3 = A2($author$project$Playground3d$point3dto2d, camera_, position);
					if (!_v3.$) {
						var point = _v3.a;
						return point;
					} else {
			...
			default:
				...
				return $evancz$elm_playground$Playground$group(
					A2(
						$elm$core$List$map,
						$author$project$Playground3d$shape3dto2d(camera_),
						shapes));
		}
	});
...
var $evancz$elm_playground$Playground$darkBrown = $evancz$elm_playground$Playground$Hex('#8f5902');
var $evancz$elm_playground$Playground$darkGreen = $evancz$elm_playground$Playground$Hex('#4e9a06');
var $evancz$elm_playground$Playground$green = $evancz$elm_playground$Playground$Hex('#73d216');
var $evancz$elm_playground$Playground$lightBrown = $evancz$elm_playground$Playground$Hex('#e9b96e');
var $evancz$elm_playground$Playground$lightGreen = $evancz$elm_playground$Playground$Hex('#8ae234');
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$Main$pyramid = F4(
	function (color1, color2, color3, size) {
		var b = $elm$core$Basics$sqrt(3);
		var base1 = _Utils_Tuple3(0.5, 0.5 / b, 0);
		var base2 = _Utils_Tuple3(0, (0.5 / b) * (-2), 0);
		var base3 = _Utils_Tuple3(-0.5, 0.5 / b, 0);
		var top = _Utils_Tuple3(
			0,
			0,
			$elm$core$Basics$sqrt(
				1 - A2($elm$core$Basics$pow, 0.5 / b, 2)));
		return A2(
			$author$project$Playground3d$scale3d,
			size,
			$author$project$Playground3d$group3d(
...
var $author$project$Main$tree = $author$project$Playground3d$group3d(
	_List_fromArray(
		[
			A4(
			$author$project$Playground3d$move3d,
			...
			0,
			-100,
			A4($author$project$Playground3d$cube, $evancz$elm_playground$Playground$lightBrown, $evancz$elm_playground$Playground$brown, $evancz$elm_playground$Playground$darkBrown, 100)),
			A4($author$project$Main$pyramid, $evancz$elm_playground$Playground$darkGreen, $evancz$elm_playground$Playground$green, $evancz$elm_playground$Playground$lightGreen, 600),
			A4(
			$author$project$Playground3d$move3d,
			0,
			0,
			...
			0,
			1000,
			A4($author$project$Main$pyramid, $evancz$elm_playground$Playground$darkYellow, $evancz$elm_playground$Playground$yellow, $evancz$elm_playground$Playground$lightYellow, 100)),
			A4(
			$author$project$Playground3d$rotate3d,
			0,
			180,
			0,
			A4(
...
var $author$project$Playground3d$words3d = F2(
	function (color, string) {
		return A2(
			$author$project$Playground3d$Shape3d,
			1,
...
var $author$project$Main$main = $evancz$elm_playground$Playground$animation(
	function (time) {
		return _List_fromArray(
			[
				A2(
				$author$project$Playground3d$shape3dto2d,
				$author$project$Playground3d$camera1,
				A2(
					$author$project$Playground3d$scale3d,
					2,
					A4(
						...
						0,
						800,
						A2($author$project$Playground3d$words3d, $evancz$elm_playground$Playground$red, 'MERRY CHRISTMAS')))),
				A2(
				$author$project$Playground3d$shape3dto2d,
				$author$project$Playground3d$camera1,
				A4(
					...
					A4(
						...
						0,
						-400,
						A2($author$project$Playground3d$fade3d, 0.5, $author$project$Main$tree)))),
				A2(
				$evancz$elm_playground$Playground$rotate,
				A2($evancz$elm_playground$Playground$spin, 3, time),
				A3(
					$evancz$elm_playground$Playground$move,
					-100,
					-250,
					A2(
						...
						A4(
							...
							A2($evancz$elm_playground$Playground$spin, 6, time),
							A2(
								$author$project$Playground3d$fade3d,
								0.5,
								A4($author$project$Playground3d$cube, $evancz$elm_playground$Playground$lightYellow, $evancz$elm_playground$Playground$yellow, $evancz$elm_playground$Playground$darkYellow, 200)))))),
				A2(
				$evancz$elm_playground$Playground$rotate,
				A2($evancz$elm_playground$Playground$spin, 3, time),
				A3(
					...
					A2(
						...
						A4(
							...
							A2(
								$author$project$Playground3d$fade3d,
								0.5,
								A4($author$project$Playground3d$cube, $evancz$elm_playground$Playground$lightRed, $evancz$elm_playground$Playground$red, $evancz$elm_playground$Playground$darkRed, 200)))))),
				A2(
				$evancz$elm_playground$Playground$rotate,
				A2($evancz$elm_playground$Playground$spin, 3, time),
				A3(
